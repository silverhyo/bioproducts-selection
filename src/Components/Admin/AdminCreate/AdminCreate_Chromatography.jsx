...
// import Style
import './AdminCreate_Chromatography.css';

export default function AdminCreate_Chromatography({productsType}) {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('PType', productsType);
        ...
        <form className='RegisterForm_Container_Box_Form' onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <div className='Service_Container'>
            <div className='Service_Container_Box'>
              <p className='Service_Container_Box_P'><span>😜</span> <strong>Service</strong>를 선택해 주세요.</p>
              <label className='Service_Container_Box_Label' htmlFor='service_type'></label>
              <select className='Service_Container_Box_Select' id="service_type" onChange={e => setService(e.target.value)}>
                <option className='Service_Container_Box_Option' name="ServiceType" value="">Service를 선택해 주세요</option>
                {jsonData01.Service.map((item, index) => {
                  return (
                    <option className='Service_Container_Box_Option' key={index} name="ProductType" value={item.Value}>{item.Title}</option>
                  )
                })};
              </select>
            </div>
          ...
          {/* DescriptionA */}
          <div className='Description01_Container'>
            <div className='Description01_Container_Box'>
              
              <p className='Description01_Container_Box_P'><span>제품등록 1</span> : 제품에 대한 <strong>상세 설명</strong>을 입력해 주세요.</p>

              <div className="Description01_Container_Box_P_Small">
                <p className='Description01_Container_Box_P_Small_P'></p>
                <img className='Description01_Container_Box_P_Small_Image' src={imgFileA ? imgFileA : ``} alt="" /><br />
                <input className='Description01_Container_Box_P_Small_Input1' type="file" name="DescriptionA1" id="fileInputA" ref={imgRefA} accept="image/*" onChange={settingDetailA1} /><br/><br/>
                <input className='Description01_Container_Box_P_Small_Input2' type="text" name="DescriptionA2" placeholder="주요 문구를 입력해 주세요" onChange={e => setDescriptionA2(e.target.value)}></input><br/><br/>
                <textarea className='Description01_Container_Box_P_Small_Textarea' cols="60" rows="10" name="DescriptionA3" placeholder="간단한 설명을 입력해 주세요" onChange={e => setDescriptionA3(e.target.value)} />
              </div>
          ...
          {/* DescriptionB */}
          <div className='Description02_Container'>
            <div className='Description02_Container_Box'>
              
              <p className='Description02_Container_Box_P'><span>제품등록 2</span> : 제품에 대한 <strong>상세 설명</strong>을 입력해 주세요.</p>

              <div className="Description02_Container_Box_P_Small">
                <p className='Description02_Container_Box_P_Small_P'></p>
                <img className='Description02_Container_Box_P_Small_Image' src={imgFileB ? imgFileB : ``} alt="" /><br />
                <input className='Description02_Container_Box_P_Small_Input1' type="file" name="DescriptionB1" ref={imgRefB} id="fileInputB" accept="image/*" onChange={settingDetailB1} /><br/><br/>
                <input className='Description02_Container_Box_P_Small_Input2' type="text" name="DescriptionB2" placeholder="주요 문구를 입력해 주세요" onChange={e => setDescriptionB2(e.target.value)}></input><br/><br/>
                <textarea className='Description02_Container_Box_P_Small_Textarea' cols="60" rows="10" name="DescriptionB3" placeholder="간단한 설명을 입력해 주세요" onChange={e => setDescriptionB3(e.target.value)} />
              </div>
          ...
          {/* DescriptionC*/}
          <div className='Description03_Container'>
            <div className='Description03_Container_Box'>
              
              <p className='Description03_Container_Box_P'><span>제품등록 3</span> : 제품에 대한 <strong>상세 설명</strong>을 입력해 주세요.</p>

              <div className="Description03_Container_Box_P_Small">
                <p className='Description03_Container_Box_P_Small_P'></p>
                <img className='Description03_Container_Box_P_Small_Image' src={imgFileC ? imgFileC : ``} alt="" /><br />
                <input className='Description03_Container_Box_P_Small_Input1' type="file" name="DescriptionC1" ref={imgRefC} id="fileInputC" accept="image/*" onChange={settingDetailC1} /><br/><br/>
                <input className='Description03_Container_Box_P_Small_Input2' type="text" name="DescriptionC2" placeholder="주요 문구를 입력해 주세요" onChange={e => setDescriptionC2(e.target.value)}></input><br/><br/>
                <textarea className='Description03_Container_Box_P_Small_Textarea' cols="60" rows="10" name="DescriptionC3" placeholder="간단한 설명을 입력해 주세요" onChange={e => setDescriptionC3(e.target.value)} />
              </div>
          ...
          {/* DescriptionD */}
          <div className='Description04_Container'>
            <div className='Description04_Container_Box'>
              
              <p className='Description04_Container_Box_P'><span>제품등록 4</span> : 제품에 대한 <strong>상세 설명</strong>을 입력해 주세요.</p>

              <div className="Description04_Container_Box_P_Small">
                <p className='Description04_Container_Box_P_Small_P'></p>
                <img className='Description04_Container_Box_P_Small_Image' src={imgFileD ? imgFileD : ``} alt="" /><br />
                <input className='Description04_Container_Box_P_Small_Input1' type="file" name="DescriptionD1" ref={imgRefD} id="fileInputD" accept="image/*" onChange={settingDetailD1} /><br/><br/>
                <input className='Description04_Container_Box_P_Small_Input2' type="text" name="DescriptionD2" placeholder="주요 문구를 입력해 주세요" onChange={e => setDescriptionD2(e.target.value)}></input><br/><br/>
                <textarea className='Description04_Container_Box_P_Small_Textarea' cols="60" rows="10" name="DescriptionD3" placeholder="간단한 설명을 입력해 주세요" onChange={e => setDescriptionD3(e.target.value)} />
              </div>
          ...
          {/* DescriptionE */}
          <div className='Description05_Container'>
            <div className='Description05_Container_Box'>
              
              <p className='Description05_Container_Box_P'><span>제품등록 5</span> : 제품에 대한 <strong>상세 설명</strong>을 입력해 주세요.</p>

              <div className="Description05_Container_Box_P_Small">
                <p className='Description05_Container_Box_P_Small_P'></p>
                <img className='Description05_Container_Box_P_Small_Image' src={imgFileE ? imgFileE : ``} alt="" /><br />
                <input className='Description05_Container_Box_P_Small_Input1' type="file" name="DescriptionE1" ref={imgRefE} id="fileInputE" accept="image/*" onChange={settingDetailE1} /><br/><br/>
                <input className='Description05_Container_Box_P_Small_Input2' type="text" name="DescriptionE2" placeholder="주요 문구를 입력해 주세요" onChange={e => setDescriptionE2(e.target.value)}></input><br/><br/>
                <textarea className='Description05_Container_Box_P_Small_Textarea' cols="60" rows="10" name="DescriptionE3" placeholder="간단한 설명을 입력해 주세요" onChange={e => setDescriptionE3(e.target.value)} />
              </div>
          ...
          <hr className='CreateRegisterForm_Container_Box_Form_Hr01'></hr>
          <input className='CreateRegisterForm_Container_Box_Form_Input' type="submit" value="등록하기"></input>
